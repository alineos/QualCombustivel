...
class MainActivity : AppCompatActivity(), OnClickListener {
    ...
    private lateinit var mTextView: TextView
        ...
        /**
         * Faz o calculo de qual dos combustíveis é mais vantajoso para o abastecimento.
         * O método valida os dados de entrada e apresenta as mensagens diretamente em objetos do leiaute.
         */

        private fun calculate() {
            if (gasolineEditText.text.toString().isEmpty() || ethanolEditText.text.toString().isEmpty()) {
                Toast.makeText(
                    this, getString(R.string.value_fuel),
        ...
        private fun retriveValue(input: EditText): Double {
            return try {
                ...
                Toast.makeText(this, getString(R.string.value_invalid), Toast.LENGTH_SHORT).show()
                0.0
            }
        }
